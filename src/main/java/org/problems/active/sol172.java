...
/**
 * https://leetcode.com/contest/weekly-contest-188/problems/number-of-ways-of-cutting-a-pizza/
 * 
 ...
 * 
 * Example 1:
 * Input: pizza = ["A..","AAA","..."], k = 3 Output: 3 Explanation: The figure
 * above shows the three ways to cut the pizza. Note that pieces must contain at
 * least one apple. 
 * 
 * Example 2:
 * 
