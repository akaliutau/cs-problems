 ...
 * B = [A[i], A[i+1], ..., A[j]] (with i <= j),
 * we take the bitwise OR of all the elements in B, obtaining a result 
 * A[i] | A[i+1] | ... | A[j].
 * 
 ...
 * Example 3:
 * 
 * Input: [1,2,4] Output: 6 Explanation: The possible results are 1, 2, 3, 4, 6,
 * and 7.
 * 
 * 
 * Note:
