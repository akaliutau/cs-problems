 ...
 * 
 * You are given an integer n. You will apply the following steps exactly two
 * times:
 * 
 ...
 * representation of n by y. The new integer cannot have any leading zeros,
 * also the new integer cannot be 0. Let a and b be the results of applying the
 * operations to n the first and second times, respectively.
 * 
 * Return the max difference between a and b.
 * 
 * Example 1:
 * 
 * Input: n = 555 Output: 888 
