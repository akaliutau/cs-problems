 ...
 * 
 */
public class CombinatioSumIv2 {

	public static void combination(int[] candidates, int idx, int target, int[] result,
	...
	public static List<List<Integer>> combinationSum(int[] candidates, int target) {
		...
		int[] result = new int[Math.max(target, candidates.length)];
